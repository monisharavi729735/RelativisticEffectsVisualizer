...
const RelativityPage = () => {
  ...
  return (
    <div>
    <div className="flex flex-row items-start justify-center space-x-10 mx-14">
        {/* Left Side: Headings/Text */}
        <div className="flex flex-col justify-start items-start w-2/5 text-left">
          ...
          <h4 className="text-xl font-bold mt-6 mb-20 text-white">
            Explore the mind-bending effects of traveling near the speed of light.
          </h4>
        </div>

        {/* Right Side: User Manual Block */}
        <Link to="/concept" className="w-1/4">
          <div className="relative bg-white/10 rounded-lg border border-white/20 shadow-lg p-10 h-40 m-4 flex justify-center items-center flex-shrink-0 hover:bg-white/20 transition-colors duration-200 cursor-pointer">
            <div className="w-full flex justify-center items-center">
              <p className="text-xl font-bold mt-4 text-white">Read Before You Board the Rocket🚀</p>
            </div>
          </div>
        </Link>
      </div>
